...
const UsersDataTable = ({ items, onEditRow, onRowDelete, onRowClick }) => {
    ...
    const switchTemplate4 = (rowData, { rowIndex }) => <InputSwitch checked={rowData.isAnAdmin}  />
    ...
    return (
        <DataTable value={items} onRowClick={onRowClick} scrollable rowHover paginator rows={10}>
            ...
            <Column field="phoneNumber" header="Phone Number" body={inputTemplate3} style={{ minWidth: "8rem" }} />
            <Column field="isAnAdmin" header="IsAnAdmin" body={switchTemplate4} style={{ minWidth: "8rem" }} />
